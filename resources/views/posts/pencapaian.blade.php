...
<div class="container threecolumns">
    ...
    <div class="row">
        <div class="col-md-8 blog-main">
            ...
            <div class="container">
                <div class="blog-post">
                    @foreach($pencapaian as $key => $data)
                        <div class="card">
                            <div class="card-body">
                                <img class="card-img-top center" style="width:350px;height:450px;" src={{$data->content_pencapaian}} alt="Card image cap">   
                            </div>    
                        </div><!-- /.card -->
                        <br><br>
                    @endforeach
