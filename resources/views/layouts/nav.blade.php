<header>
  <nav class="navbar navbar-expand-lg navbar-light rounded navigationbar">
    
    <a class="navbar-brand" href="/">
      <img src="/img/webicon/masjid_icon.jpg" width="30" height="30" class="d-inline-block align-top" alt="">
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdown09">
            ...
            <a class="dropdown-item" href="jawatankuasa">JAWATANKUASA MASJID</a>
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="http://example.com" id="dropdown09" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">GALERI</a>
          <div class="dropdown-menu" aria-labelledby="dropdown09">
